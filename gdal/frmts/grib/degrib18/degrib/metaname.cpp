...
/* 192 */    {"CRAIN", "Categorical Rain", "0=no; 1=yes", UC_NONE},
/* 193 */    {"CFRZR", "Categorical Freezing Rain", "0=no; 1=yes", UC_NONE},
/* 194 */    {"CICEP", "Categorical Ice Pellets", "0=no; 1=yes", UC_NONE},
/* 195 */    {"CSNOW", "Categorical Snow", "0=no; 1=yes", UC_NONE},
/* 196 */    {"CPRAT", "Convective Precipitation Rate", "kg/(m^2*s^1)", UC_NONE},
/* 197 */    {"MCONV", "Horizontal Moisture Divergence", "kg/(kg^1*s^1)", UC_NONE},
/* 198 */    {"MINRH", "Minimum Relative Humidity", "%", UC_NONE},
/* 199 */    {"PEVAP", "Potential Evaporation", "kg/(m^2)", UC_NONE},
/* 200 */    {"PEVPR", "Potential Evaporation Rate", "W/(m^2)", UC_NONE},
/* 201 */    {"SNOWC", "Snow Cover", "%", UC_NONE},
/* 202 */    {"FRAIN", "Rain Fraction of Total Liquid Water", "non-dim", UC_NONE},
/* 203 */    {"RIME", "Rime Factor", "non-dim", UC_NONE},
/* 204 */    {"TCOLR", "Total Column Integrated Rain", "kg/(m^2)", UC_NONE},
/* 205 */    {"TCOLS", "Total Column Integrated Snow", "kg/(m^2)", UC_NONE},
/* 206 */    {"TIPD", "Total Icing Potential Diagnostic", "non-dim", UC_NONE},
/* 207 */    {"NCIP", "Number concentration for ice particles", "non-dim", UC_NONE},
/* 208 */    {"SNOT", "Snow temperature", "K", UC_NONE},
/* 209 */    {"TCLSW", "Total column-integrated supercooled liquid water", "kg/(m^2)", UC_NONE},
/* 210 */    {"TCOLM", "Total column-integrated melting ice", "kg/(m^2)", UC_NONE},
/* 211 */    {"EMNP", "Evaporation - Precipitation", "cm/day", UC_NONE},
/* 212 */    {"SBSNO", "Sublimation (evaporation from snow)", "W/(m^2)", UC_NONE},
/* 213 */    {"CNVMR", "Deep Convective Moistening Rate", "kg/(kg^1*s^1)", UC_NONE},
/* 214 */    {"SHAMR", "Shallow Convective Moistening Rate", "kg/(kg^1*s^1)", UC_NONE},
/* 215 */    {"VDFMR", "Vertical Diffusion Moistening Rate", "kg/(kg^1*s^1)", UC_NONE},
/* 216 */    {"CONDP", "Condensation Pressure of Parcali Lifted From Indicate Surface", "Pa", UC_NONE},
/* 217 */    {"LRGMR", "Large scale moistening rate", "kg/(kg^1*s^1)", UC_NONE},
/* 218 */    {"QZ0", "Specific humidity at top of viscous sublayer", "kg/(kg^1)", UC_NONE},
/* 219 */    {"QMAX", "Maximum specific humidity at 2m", "kg/(kg^1)", UC_NONE},
/* 220 */    {"QMIN", "Minimum specific humidity at 2m", "kg/(kg^1)", UC_NONE},
/* 221 */    {"ARAIN", "Liquid Precipitation (Rainfall)", "kg/(m^2)", UC_NONE},
/* 222 */    {"SNOWT", "Snow temperature, depth-avg", "K", UC_NONE},
/* 223 */    {"APCPN", "Total precipitation (nearest grid point)", "kg/(m^2)", UC_NONE},
/* 224 */    {"ACPCPN", "Convective precipitation (nearest grid point)", "kg/(m^2)", UC_NONE},
/* 225 */    {"FRZR", "Freezing Rain", "kg/(m^2)", UC_NONE},
/* 226 */    {"PWTHER", "Pblackominant Weather", "Numeric", UC_NONE},
/* 227 */    {"FROZR", "Frozen Rain", "kg/(m^2)", UC_NONE},
/* 228 */    {"FICEAC", "Flat Ice Accumulation (FRAM)", "kg/(m^2)", UC_NONE},
/* 229 */    {"LICEAC", "Line Ice Accumulation (FRAM)", "kg/(m^2)", UC_NONE},
/* 230 */    {"SLACC", "Sleet Accumulation", "kg/(m^2)", UC_NONE},
/* 231 */    {"PPINDX", "Precipitation Potential Index", "%", UC_NONE},
/* 232 */    {"PROBCIP", "Probability Cloud Ice Present", "%", UC_NONE},
/* 233 */    {"SNOWLR", "Snow Liquid ratio", "kg/(kg^1)", UC_NONE},
};
